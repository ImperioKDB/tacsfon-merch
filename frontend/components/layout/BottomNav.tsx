...
/**
 * BottomNav
 * Deep premium green (#2A9E5A), black icons + labels.
 * Active: full black. Idle: 55% black opacity.
 * White top indicator bar on active tab.
...
const ICON_IDLE   = 'rgba(0,0,0,0.45)'
const LBL_ACTIVE  = '#0A0A0A'
const LBL_IDLE    = 'rgba(0,0,0,0.45)'
...
const TABS = [
  {
    ...
    icon: (a: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24"
        fill={a ? ICON_ACTIVE : 'none'}
        stroke={a ? ICON_ACTIVE : ICON_IDLE} strokeWidth="1.8">
  ...
  return (
    <>
      <nav aria-label="Mobile navigation" className="bottom-nav" style={{
        ...
        alignItems: 'stretch',
        background: NAV_BG,
        boxShadow:  '0 -3px 16px rgba(42,158,90,0.35)',
      }}>
        {TABS.map(tab => {
