  ...
  return (
    <div className="flex gap-4 p-4 rounded-2xl border"
      ...
      <div className="relative flex-shrink-0 rounded-xl overflow-hidden"
        style={{ width: 80, height: 80, background: 'var(--color-surface-2)' }}>
        {product?.image_url ? (
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between">
        <div>
          ...
          <p className="text-sm mt-1 font-medium" style={{ color: 'var(--color-gold)' }}>
            {fmt(unitPrice)}
          </p>
        </div>
        <div className="flex items-center gap-2 mt-3">
          {[
            ...
            <>
              ...
              <button key={label} onClick={() => changeQty(qty + delta)}
