      ...
      <section style={{ maxWidth: '720px', margin: '0 auto', padding: '56px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {WA_NUMBER ? (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: 'var(--font-urbanist)', fontWeight: 700, fontSize: '1.125rem', color: 'var(--color-text-primary)', marginBottom: '4px' }}>Chat on WhatsApp</p>
              <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.875rem', color: 'var(--color-text-secondary)', lineHeight: '1.5' }}>The fastest way to reach us. We typically respond within a few hours.</p>
            </div>
